...
local config = {
  options = {
    ...
    theme = {
      ...
      normal = { c = { fg = colors.hint, bg = colors.bg } },
      inactive = { c = { fg = colors.hint, bg = colors.bg } },
    },
  },
  sections = {
...
ins_left({
  ...
  color = { fg = colors.hint }, -- Sets highlighting of component
...
--   -- Lsp server name .
--   function()
--     local msg = " Christo Nihil Præponere "
